...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3>Nuevo Miembro del consejo directivo</h3>
        @if (count($errors)>0)
    ...
    <div class="box-body">
        <div class="row">
            {!!Form::open(array('url'=>'admin/consejo','method'=>'POST','autocomplete'=>'off','files'=>'true'))!!}
            {{Form::token()}}
            ...
            <div class="col-log-4 col-md-4 col-sm-4 col-xs-6">
                <div class="form-group">
                    ...
                    <select name="grado" id="" class="form-control">
                        @foreach ($gradosacademicos as $car)
                        <option value="{{$car->id}}">{{$car->grado}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
