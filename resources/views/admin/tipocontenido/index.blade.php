...
@section('contenido')
@include('admin.tipocontenido.create')
<!--------------------------------------------------------------------------------------------------------->
<div class="row">
    <div class="col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                @include('admin.tipocontenido.search')
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 138px">
                                <a href="{{URL::action('admin\tipocontenidoController@show',$tipo->id)}}"><button
                                        class="btn btn-success"><i class="fa fa-arrow-circle-down"></i></button></a>
                                <a href="{{URL::action('admin\tipocontenidoController@edit',$tipo->id)}}"><button
                        ...
                        @include('admin.tipocontenido.modal')
                        @endforeach
                    </tbody>
                </table>
            </div>
