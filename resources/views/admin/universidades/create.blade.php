<div class="box box-primary">
    ...
    <div class="box-body">
        <div class="row">
            {!!Form::open(array('url'=>'admin/universidades','method'=>'POST','autocomplete'=>'off'))!!}
            {{Form::token()}}
            <div class="col-log-10 col-md-10 col-sm-10 col-xs-12">
                <div class="form-group">
                    <label for="nombre">Nombre</label>
                    <input type="text" name="nombre" class="form-control" placeholder="Ingrese Universidad">
                </div>
            </div>
            <div class="col-log-2 col-md-2 col-sm-2 col-xs-12">
                <div class="form-group">
                    <label for="nombre">Abreviatura</label>
                    <input type="text" name="abreviatura" class="form-control" placeholder="Ingrrese Abreviatura">
                </div>
            </div>
